...
function TextEditor() {
  ...
  return (
    <div className="w-screen h-screen overflow-auto bg-gray-100">
      <div className="min-w-[1200px] h-full flex flex-col bg-gray-50">
        {" "}
        <div className="bg-[#000000] text-white p-4 shadow-sm">
          ...
          <button
            ...
            className="mb-2 mt-1 top-10 left-4 sm:left-8 flex items-center "
          >
            <div className="p-[5px] sm:p-[6px] border-[2px] text-[#ffffff] border-[#ffffff] rounded-lg">
              <FaAngleLeft className="text-[#ffffff]" />
            </div>{" "}
            <span className="text-lg ml-1 font-medium text-[#ffffff]">
              Go To Dashboard
            </span>
          </button>
          <h1 className="text-xl sm:text-2xl font-bold">
            Seydam AI-Powered Report Editor
          </h1>
          <p className="text-blue-50 text-sm sm:block">
            {source === "generated"
