  ...
  return (
    ...
    >
      <div className="relative text-center">
        <h1 className="text-[33px] sm:text-6xl font-bold text-gray-900 leading-tight pt-14 ">
          Get your{" "}
        ...
        <div className="flex justify-center mt-6 gap-4 font-medium">
          <Link to="/signup">
            <button className="border-[2px] border-[#0D0D82] flex items-center gap-2 px-6 py-2 bg-[#0D0D82] text-white rounded-md  transition duration-200">
              Get Started
              {/* <FiFeather className="text-white" /> */}
            </button>
          </Link>{" "}
          <Link to="/signup">
            <button className=" hidden sm:flex items-center gap-2 px-6 py-2 border-[2px] border-[#0D0D82] text-[#0D0D82] rounded-md  transition duration-200">
              See How It Works
              {/* <FiFeather className="text-white" /> */}
            </button>
          </Link>
